  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.titulo}>Derivados</Text>
...
const Produtos = [
  ...
  {
    nome: 'Creme de Leite',
    foto: require('../assets/assets/creme-leite.png'),
    preco: '3.00',
    grandeza: 'Kg',
  },
   {
  ...
  {
    nome: 'Rqueijão',
    foto: require('../assets/assets/requeijao.png'),
    preco: '7.00',
    grandeza: 'Kg',
  },
  {
    nome: 'Margarina',
    foto: require('../assets/assets/margarina.png'),
    preco: '7.00',
    grandeza: 'Kg',
  },
  {
    nome: 'Cream Chease',
    foto: require('../assets/assets/cream-chease.png'),
    preco: '7.00',
    grandeza: 'Kg',
  }
];
