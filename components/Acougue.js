...
const Produtos = [
  {
    nome: 'Alcatra',
    foto: require('../assets/assets/alcatra.png'),
    preco: '7.00',
    grandeza: 'Kg',
  },
  {
    nome: 'Maminha',
    foto: require('../assets/assets/maminha.png'),
    preco: '3.00',
    grandeza: 'Kg',
  },
   {
    nome: 'Coxão Mole',
    foto: require('../assets/assets/coxao-mole.png'),
    preco: '7.00',
    grandeza: 'Kg',
  },
  {
    nome: 'Coxão Duro',
    foto: require('../assets/assets/coxao-duro.png'),
    preco: '7.00',
    grandeza: 'Kg',
  },
  {
    nome: 'Picanha',
    foto: require('../assets/assets/picanha.png'),
    preco: '7.00',
    grandeza: 'Kg',
  },
  {
    nome: 'Peito de Frango',
    foto: require('../assets/assets/peito-frango.png'),
    preco: '7.00',
    grandeza: 'Kg',
  }
];
