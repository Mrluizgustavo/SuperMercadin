...
const Produtos = [
  {
    nome: 'Amaciante',
    foto: require('../assets/assets/amaciante.png'),
    preco: '7.00',
    grandeza: 'Kg',
  },
  {
    nome: 'Candida',
    foto: require('../assets/assets/candida.png'),
    preco: '3.00',
    grandeza: 'Kg',
  },
   {
    nome: 'Detergente',
    foto: require('../assets/assets/detergente.png'),
    preco: '7.00',
    grandeza: 'Kg',
  },
  {
    nome: 'Bombril',
    foto: require('../assets/assets/bombril.png'),
    preco: '7.00',
    grandeza: 'Kg',
  },
  {
    nome: 'Limpa Alumínio',
    foto: require('../assets/assets/limpa-aluminio.png'),
    preco: '7.00',
    grandeza: 'Kg',
  },
  {
    nome: 'Vanish',
    foto: require('../assets/assets/vanish.png'),
    preco: '7.00',
    grandeza: 'Kg',
  }
];
